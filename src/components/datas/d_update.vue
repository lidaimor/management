...
<script>
  ...
  export default {
    ...
    mounted:function(){
      ...
      this.dataName = this.item.dataName;
      this.dataDesc = this.item.dataDesc;
      this.did = this.item.did;
    },
    methods:{
      back(){
      ...
      up(){
        ...
        $.ajax({
          ...
          data: JSON.stringify({did: that.did.toString(),url: that.url,dataFile: that.fileName, cid: that.cid.toString(),
